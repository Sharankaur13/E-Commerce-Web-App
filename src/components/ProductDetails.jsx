...
const ProductDetails = () => {
  ...
  const check_category = product.category
   const isClothing = ['men', 'women'].includes(check_category)
  const isHome = check_category === 'home'
  const isKids = check_category === 'kid'
  const nextSlide = () => {
    ...
    {images.map((img, index) => (
      ...
      />
       ...
       <FaArrowLeft onClick={prevSlide} className='absolute top-1/2 h-7 w-9 left-20 rounded-2xl text-black ' />
        ...
        {isClothing && (<div className='flex flex-col gap-4  w-90 p-3 rounded-lg shadow-2xl'>
        <p>{product.desc}</p>
       ...
       {isHome &&(<div className='flex flex-col gap-4  w-90 p-3 rounded-lg shadow-2xl'>
        <p>{product.desc}</p>
       ...
       {isKids && (<div className='flex flex-col gap-4  w-90 p-3 rounded-lg shadow-2xl'>
        <p>{product.desc}</p>
